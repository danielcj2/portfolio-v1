  ...
  return (
    <div className="section d-flex flex-column justify-content-center">
      <div className="about text-left" id="about">
        ...
        <p className="d-flex align-items-center flex-wrap">Feel free to hit me up! I tend to respond fairly quick. <HashLink className="contact-btn curtain text-center interactable" to="/#contact" scroll={scrollWidthOffset}>Contact</HashLink></p>
