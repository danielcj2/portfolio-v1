  ...
  return (
    <div className="section d-flex flex-column justify-content-center">
      <div className="about text-left" id="about">
        ...
        <RevealFramer><p>Hello! My name is Daniel and I enjoy building clean and scalable frontend applications with exceptional user experiences. I have recently graduated from <a className="underline-slide" href="https://www.trentu.ca/" target="_blank" rel="noopener noreferrer">Trent University</a> with a degree in <a className="underline-slide" href="https://www.trentu.ca/durham/academics/degrees-and-programs/computer-science-bsc" target="_blank" rel="noopener noreferrer">Computer Science</a> in the Honours Program.</p></RevealFramer>
