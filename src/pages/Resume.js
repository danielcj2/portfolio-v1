...
const Resume = () => {
  return (
    <main className="resume d-flex">
      <aside><a className="resume-pdf d-flex align-items-center interactable" href={resumePDF} target="_blank" rel="noopener noreferrer" download="resume.pdf"><MdSimCardDownload className="svg-dl"/>Grab a Copy</a></aside>
      <div>
        <section>
        ...
        <section>
          ...
          <a href="https://www.trentu.ca/" target="_blank" rel="noopener noreferrer" className="uni interactable">Trent University, Peterborough, ON</a>
      ...
      <article className="flex-fill">
        <section className="right-side">
          ...
          <div className="project-container">
            ...
            <a className="project-source interactable" href="https://www.github.com/danielcj2/movie-ranker-js" target="_blank" rel="noopener noreferrer">github.com/danielcj2/movie-ranker-js</a>
          ...
          <div className="project-container">
            ...
            <a className="project-source interactable" href="https://www.github.com/danielcj2/vsidle-game" target="_blank" rel="noopener noreferrer">github.com/danielcj2/vsidle-game</a>
